...
本文档定义新个人博客系统的编码层设计，用于指导后续真正创建 `web`、`server`、`worker`、`deploy` 等工程目录。它承接现有架构、产品、API 与路线图文档，重点回答“代码应该如何组织、如何命名、如何分层、如何协作”。
...
- CSS 类使用 CreamyUI 风格的 `cui-*` BEM 命名。
